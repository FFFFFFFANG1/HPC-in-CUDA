...
Course final project for ECE 408 FA23 @ UIUC. For original project description, see [Cuda LeNet/README.md](CUDA_LeNet/README.md).

### Optimization Techniques
For a more comprehensive discussion, see [Cuda LeNet/report.pdf](CUDA_LeNet/report.pdf). Below is a table of optimization techniques:
| Name                | Techiques                    |
| --------------------------- | ---------------------- |
| Req 0 | Stream |
| Req 1 | Tensor Core |
